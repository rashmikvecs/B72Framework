...
public class BaseTest {
	...
	@BeforeMethod
	public void preCondition(@Optional(DEFAULT_URL) String appURL, @Optional(DEFAULT_GRID) String grid,@Optional(DEFAULT_BROWSER)String browser) throws MalformedURLException {
